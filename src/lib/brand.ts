...
export const BRAND = {
  ...
  pitch:
    "Stake tokenized shares of your stock. They stake theirs. At the bell, whichever moved more in percent takes every share on the table. Signed prices decide it, anyone can settle it, and no house takes a cut.",
} as const;
